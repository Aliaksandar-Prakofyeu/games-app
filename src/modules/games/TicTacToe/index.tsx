...
import {boardTile, gameStatusEnum} from '../../../consts/game'
...
export const TicTacToeBoard: React.FC<Props> = ({roomId, username}) => {
    const [boardTileInfo, setBoardTileInfo] = useState<BoardTileInfoProps[]>(boardTile)
    const [playerSymbol, setPlayerSymbol] = useState('')
    const [isMyTurn, setIsMyTurn] = useState<boolean>(false)
    const [gameStatus, setGameStatus] = useState<gameStatusEnum>(gameStatusEnum.WAIT)
    ...
    async function socketInitializer({
        ...
        fetch('/api/tic').finally(() => {
            socket = io()

            socket.emit('join_tic_room', {
                username,
                roomId,
            ...
            socket.on('receive_message_tic', (data: BoardTileInfoProps) => {
